      ...
      <div className="flex flex-wrap items-end gap-6">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            ...
            onChange={e => onFilter('bloque', e.target.value)}
            className="w-56 rounded-md border border-slate-300 px-3 py-2 text-sm text-slate-800 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100"
          >
            <option value="">— All blocks —</option>
            <option value="Ejecución Técnica">Ejecución Técnica</option>
            <option value="Especialistas & Diseño">Especialistas & Diseño</option>
            <option value="Producto & Gobierno">Producto & Gobierno</option>
          </select>
        </div>
      </div>
    </div>
